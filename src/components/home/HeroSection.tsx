    ...
    <section className="luxury-dark-section relative flex min-h-[88vh] items-start overflow-visible pt-0">
      <div className="absolute inset-0 z-0 overflow-hidden">
        <Image
          ...
          priority
          sizes="100vw"
          className="hero-image-zoom parallax-bg h-full w-full object-cover object-top opacity-100"
        />
        ...
        <div className="absolute inset-0 bg-[linear-gradient(105deg,rgba(4,31,25,0.72)_0%,rgba(4,31,25,0.46)_38%,rgba(4,31,25,0.13)_68%,rgba(4,31,25,0.22)_100%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_26%,rgba(202,162,77,0.16),transparent_24%),radial-gradient(circle_at_78%_18%,rgba(13,107,83,0.1),transparent_30%),linear-gradient(to_bottom,rgba(4,31,25,0.02),rgba(4,31,25,0.34))]" />
        <div className="absolute inset-y-0 left-0 w-full bg-[linear-gradient(to_right,rgba(4,31,25,0.72),rgba(4,31,25,0.34),transparent)] md:w-[66%]" />
        <div className="absolute inset-x-0 bottom-0 h-36 bg-gradient-to-t from-[#041f19]/80 to-transparent" />
      </div>

      <div className="ambient-orb ambient-orb-gold floating-glow morphing-blob left-[5%] top-[18%] h-40 w-40 opacity-32 blur-3xl" />
      <div className="ambient-orb ambient-orb-green floating-glow morphing-blob right-[10%] top-[22%] h-60 w-60 opacity-26 blur-3xl" />
